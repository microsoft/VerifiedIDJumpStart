# Welcome to Jump Start Guide for running a Verified ID Evaluation
...
Description of how to test each scenario. There is a section for each scenariow hich includes:
- A clear goal
